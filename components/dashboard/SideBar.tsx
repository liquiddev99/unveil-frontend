...
export default function SideBar() {
  ...
  return (
    <div className="min-w-[250px] mt-1 mr-5">
      ...
      <Link
        href="/dashboard"
        className={`flex items-center ${pathname === "/dashboard"
            ? "text-pink"
      ...
      <Link
        ...
        className={`flex items-center ${pathname === "/dashboard/settings"
            ? "text-pink"
            : "text-blur hover:text-slate-100"
          } pl-3 py-2 my-2 hover:bg-slate-700 transition-colors rounded cursor-pointer`}
      >
      ...
      <Link
        href="#"
        className={`flex items-center ${pathname === "mock" ? "text-pink" : "text-blur hover:text-slate-100"
          } pl-3 py-2 my-2 hover:bg-slate-700 transition-colors rounded cursor-pointer`}
      >
